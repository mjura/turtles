...
var _ = Describe("[Docker] [Kubeadm]  Create and delete CAPI cluster functionality should work with namespace auto-import", Label(e2e.KubeadmTestLabel), func() {
...
var _ = Describe("[Docker] [Kubeadm]  Create and delete CAPI cluster functionality should work with namespace auto-import with COI", Label(e2e.ShortTestLabel, e2e.KubeadmTestLabel), func() {
	var topologyNamespace string
	...
	specs.CreateMgmtV3UsingGitOpsSpec(ctx, func() specs.CreateMgmtV3UsingGitOpsSpecInput {
		testenv.CAPIOperatorDeployProvider(ctx, testenv.CAPIOperatorDeployProviderInput{
			BootstrapClusterProxy: bootstrapClusterProxy,
			CAPIProvidersOCIYAML: []testenv.CAPIProvidersOCIYAML{
				Name: "docker",
...
var _ = Describe("[Docker] [RKE2] Create and delete CAPI cluster functionality should work with namespace auto-import", Label(e2e.Rke2TestLabel), func() {
	var topologyNamespace string
